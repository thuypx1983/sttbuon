...
function optionsframework_admin_init() 
{
	...
	global $of_options, $options_machine, $kickcube_wp_data, $smof_details;
	...
	if (empty($kickcube_wp_data['smof_init'])) { // Let's set the values if the theme's already been active
...
function optionsframework_options_page(){
	...
	include( get_template_directory() . '/admin/front-end/options.php' );
...
function of_ajax_callback() 
{
	...
	elseif($save_type == 'restore_options')
	{
		...
		$kickcube_wp_data = of_get_options(BACKUPS);
	...
	elseif ($save_type == 'save')
	{
		...
		wp_parse_str(stripslashes($_POST['data']), $kickcube_wp_data);
		unset($kickcube_wp_data['security']);
		unset($kickcube_wp_data['of_save']);
		of_save_options($kickcube_wp_data);
